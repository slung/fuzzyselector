...
namespace FuzzySelector.SmartSpammer.InferenceMachine.RuleGeneration {
    ...
    public abstract class RuleActivations {
        ...
        public string toCSVFormat() {
            ...
            string result = this.deFuzzyfy(out unscaled) + "," + unscaled + ",";
            ...
            for (int i = 0; i < this.ruleDecisions.Length; ++i) {
                ...
                result += this.ruleDecisions[i].shape.name + " - " + this.getActivationLevel(i) + "(" + this.ruleDecisions[i].activationCount + " times)";
            }
