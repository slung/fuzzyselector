...
namespace FuzzySelector.SmartSpammer.InferenceMachine.RuleGeneration {
    ...
    public partial class SelectionRules : InferenceMachine {
        ...
        public SelectionRules(Functionality originalOntology, RequestShape[] requestShapes) {
            ...
            this.numberOfOutcomes = SmartSpammerSettings.Default.RULE_GENERATION_NUMBER_OF_OUTCOMES;
        ...
        public RuleActivations applyToService(Service service) {
            ...
            switch (SmartSpammerSettings.Default.RULE_GENERATION_DECISION_ACTIVATION_ALGORITHM) {
            ...
            foreach (Rule rule in this.rules) {
                ...
                if (activationLevel > 0 && this._requirementOntologies.Count > 0) {
                    ...
                    result.activate(rule.decision, SmartSpammerSettings.Default.RULE_GENERATION_RULE_ACTIVATION_ALGORITHM == (int)RuleActivationAlgorithms.minimumPropertyActivationLevel ? minActivationLevel : activationLevel / this._requirementOntologies.Count);
                }
            }
        ...
        public override string applyToServiceInCSVFormat(Service service) {
            ...
            return service.accessPoint + "," + service.name + "," + this.applyToService(service).toCSVFormat();
        }
    }
}