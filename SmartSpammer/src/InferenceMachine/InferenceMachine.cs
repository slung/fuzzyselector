...
namespace FuzzySelector.SmartSpammer.InferenceMachine {
    ...
    public abstract class InferenceMachine {
        ...
        public static double calculateImportance(int baseImportance) {
            ...
            double a = Math.Abs(SmartSpammerSettings.Default.IMPORTANCE_A);
            double b = Math.Abs(SmartSpammerSettings.Default.IMPORTANCE_B);
            double c = SmartSpammerSettings.Default.IMPORTANCE_C;

            switch (SmartSpammerSettings.Default.IMPORTANCE_FUNCTION) {
